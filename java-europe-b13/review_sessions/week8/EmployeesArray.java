...
public class EmployeesArray {
	...
	public static void main(String[] args) {
		...
		int indexOfstarting = employees[i].indexOf("[");
		int indexOfending = employees [i].indexOf("]");	
		System.out.println(employees[i].substring(indexOfstarting+1, indexOfending));	
		...
		//Philippa-Salthouse Electrical Engineer		
		for(int j=0; j<employees.length; j++) {
		int indexOfEnding = employees[j].indexOf("["); 
		int indexOfspace = employees[j].indexOf(" ");
		
		System.out.print(employees[j].substring(0, indexOfspace)+"-");
		System.out.print(employees[j].substring(indexOfspace+1, indexOfEnding));
		
		int indexOfstarting = employees[j].indexOf("[");
		int indexOfending = employees [j].indexOf("]");	
		System.out.println(" "+ employees[j].substring(indexOfstarting+1, indexOfending));
		...
		//DIFFERENT WAY FOR PREVIOUS QUESTION:
		...
		//if true verification successfull
		//else error
		boolean dummy = false;
		
		for(int k=0; k<employees.length; k++) {
			
			String name= "Tracy Bartle";
			String profession = "Geological Engineer";
			
			if(employees[k].contains(name) && employees[k].contains(profession))
