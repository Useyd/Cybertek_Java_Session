...
*/
	...
	Floor floor;// floor will access Floor class 
	Carpet carpet;//carpet will access Carpet class
	

	public Calculator(Floor floor, Carpet carpet) {//passing objects to method parameters
	...
	public double getTotalCost(){
		...
		return carpet.getCost() * floor.getArea(); //we can reach these two methods through the objects(carpet, floor)
